...
exports.THEME_NAMES = exports.THEMES = void 0;
exports.getTheme = getTheme;
exports.getNextThemeName = getNextThemeName;
/**
 * Base theme class with color interpolation logic
 */
class BaseTheme {
    constructor(name, displayName, colors) {
        this.name = name;
 ...
 */
const oceanTheme = new BaseTheme('ocean', 'Ocean', [
 ...
 */
const matrixTheme = new BaseTheme('matrix', 'Matrix', [
 ...
 */
const starlightTheme = new BaseTheme('starlight', 'Starlight', [
 ...
 */
const fireTheme = new BaseTheme('fire', 'Fire', [
 ...
 */
const monochromeTheme = new BaseTheme('monochrome', 'Monochrome', [
    { r: 0, g: 0, b: 0 }, // Black
 ...
 */
exports.THEME_NAMES = ['ocean', 'matrix', 'starlight', 'fire', 'monochrome'];
/**
 * Get a theme by name, fallback to ocean if not found
 */
function getTheme(name) {
    if (!name || !exports.THEMES[name]) {
        return exports.THEMES.ocean;
    }
    return exports.THEMES[name];
}
/**
 * Get the next theme name in the cycle
 */
function getNextThemeName(currentName) {
    const currentIndex = exports.THEME_NAMES.indexOf(currentName);
    const nextIndex = (currentIndex + 1) % exports.THEME_NAMES.length;
    return exports.THEME_NAMES[nextIndex];
}
