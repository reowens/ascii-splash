...
describe('SpiralPattern', () => {
  ...
  beforeEach(() => {
    ...
    pattern = new SpiralPattern(theme, new Mulberry32(42));
  ...
  describe('Constructor and Configuration', () => {
    ...
    test('should accept custom config', () => {
      const customPattern = new SpiralPattern(theme, new Mulberry32(42), {
        armCount: 3,
        particleCount: 150,
    ...
    test('should merge partial config with defaults', () => {
      const partialPattern = new SpiralPattern(theme, new Mulberry32(42), { armCount: 5 });
  ...
  describe('Rendering', () => {
    ...
    test('should render particles with trails', () => {
      ...
      const trailChars = ['·', '∘', '○'];
      const hasTrails = buffer.flat().some(cell => trailChars.includes(cell.char));
    ...
    test('should render multiple spiral arms', () => {
      const multiArmPattern = new SpiralPattern(theme, new Mulberry32(42), { armCount: 5 });
    ...
    test('should rotate spiral arms over time', () => {
      const rotatingPattern = new SpiralPattern(theme, new Mulberry32(42), { rotationSpeed: 0.5 });
  ...
  describe('Metrics', () => {
    ...
    test('should return correct particle count', () => {
      const customPattern = new SpiralPattern(theme, new Mulberry32(42), { particleCount: 150 });
      const metrics = customPattern.getMetrics();
    ...
    test('should return correct arms count', () => {
      const customPattern = new SpiralPattern(theme, new Mulberry32(42), { armCount: 5 });
      const metrics = customPattern.getMetrics();
  ...
  describe('Direction Modes', () => {
    test('should flow particles outward', () => {
      const outwardPattern = new SpiralPattern(theme, new Mulberry32(42), { direction: 'outward' });
    ...
    test('should flow particles inward', () => {
      const inwardPattern = new SpiralPattern(theme, new Mulberry32(42), { direction: 'inward' });
    ...
    test('should flow particles bidirectionally', () => {
      const biPattern = new SpiralPattern(theme, new Mulberry32(42), {
  ...
  describe('Edge Cases', () => {
    test('should handle zero arm count', () => {
      const zeroPattern = new SpiralPattern(theme, new Mulberry32(42), { armCount: 0 });

      expect(() => zeroPattern.render(buffer, 1000, size)).not.toThrow();
    });

    test('should handle extreme arm count', () => {
      const extremePattern = new SpiralPattern(theme, new Mulberry32(42), { armCount: 20 });

      expect(() => extremePattern.render(buffer, 1000, size)).not.toThrow();
    });

    test('should handle zero rotation speed', () => {
      const staticPattern = new SpiralPattern(theme, new Mulberry32(42), { rotationSpeed: 0 });
    ...
    test('should handle negative rotation speed', () => {
      const reversePattern = new SpiralPattern(theme, new Mulberry32(42), { rotationSpeed: -1.0 });

      expect(() => reversePattern.render(buffer, 1000, size)).not.toThrow();
    });

    test('should handle very high rotation speed', () => {
      const fastPattern = new SpiralPattern(theme, new Mulberry32(42), { rotationSpeed: 10.0 });

      expect(() => fastPattern.render(buffer, 1000, size)).not.toThrow();
    });

    test('should handle zero particle count', () => {
      const emptyPattern = new SpiralPattern(theme, new Mulberry32(42), { particleCount: 0 });
    ...
    test('should handle very high particle count', () => {
      const densePattern = new SpiralPattern(theme, new Mulberry32(42), { particleCount: 500 });

      expect(() => densePattern.render(buffer, 1000, size)).not.toThrow();
    });

    test('should handle very tight spiral', () => {
      const tightPattern = new SpiralPattern(theme, new Mulberry32(42), { spiralTightness: 0.01 });

      expect(() => tightPattern.render(buffer, 1000, size)).not.toThrow();
    });

    test('should handle very loose spiral', () => {
      const loosePattern = new SpiralPattern(theme, new Mulberry32(42), { spiralTightness: 0.5 });
