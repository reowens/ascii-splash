...
describe('FireworksPattern', () => {
  ...
  beforeEach(() => {
    ...
    pattern = new FireworksPattern(theme, new Mulberry32(42));
  ...
  describe('Constructor & Configuration', () => {
    ...
    it('should accept custom config', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), {
        burstSize: 100,
        launchSpeed: 2.0,
        gravity: 0.05,
        fadeRate: 0.025,
  ...
  describe('Rendering', () => {
    ...
    it('should render launching rockets', () => {
      ...
      const slowPattern = new FireworksPattern(theme, new Mulberry32(42), { launchSpeed: 0.5 });
    ...
    it('should render particle trails', () => {
      ...
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { trailLength: 10 });
  ...
  describe('Edge Cases', () => {
    it('should handle zero burst size', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { burstSize: 0 });
      customPattern.render(buffer, 0, size);
    ...
    it('should handle very large burst size', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { burstSize: 500 });
    ...
    it('should handle zero gravity', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { gravity: 0 });
      customPattern.render(buffer, 0, size);
    ...
    it('should handle negative gravity', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { gravity: -0.05 });
      customPattern.render(buffer, 0, size);
    ...
    it('should handle zero fade rate', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { fadeRate: 0 });
      customPattern.render(buffer, 0, size);
    ...
    it('should handle very high fade rate', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { fadeRate: 0.5 });
      customPattern.render(buffer, 0, size);
    ...
    it('should handle zero trail length', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { trailLength: 0 });
      customPattern.render(buffer, 0, size);
    ...
    it('should handle very long trails', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { trailLength: 50 });
      customPattern.render(buffer, 0, size);
    ...
    it('should handle very short spawn interval', () => {
      const customPattern = new FireworksPattern(theme, new Mulberry32(42), { spawnInterval: 100 });
  ...
  describe('Sparkle Feature Tests', () => {
    ...
    it('should respect sparkle chance config', () => {
      // High sparkle chance
      const highSparklePattern = new FireworksPattern(theme, new Mulberry32(42), {
        sparkleChance: 0.5,
      });
      ...
      // Low sparkle chance
      const lowSparklePattern = new FireworksPattern(theme, new Mulberry32(42), {
        sparkleChance: 0.01,
      });
    ...
    it('should give sparkles short lifespan (0.15-0.3)', () => {
      ...
      const quickFadePattern = new FireworksPattern(theme, new Mulberry32(42), {
    ...
    it('should render sparkle with high velocity', () => {
      ...
      const sparklePattern = new FireworksPattern(theme, new Mulberry32(42), {
        sparkleChance: 0.8,
    ...
    it('should not allow sparkles to generate secondary bursts', () => {
      ...
      const deepPattern = new FireworksPattern(theme, new Mulberry32(42), {
        sparkleChance: 1.0,
        maxBurstDepth: 3,
        burstSize: 60,
    ...
    it('should spawn 1-3 sparkles per trigger', () => {
      ...
      const deterministicPattern = new FireworksPattern(theme, new Mulberry32(42), {
        sparkleChance: 0.8,
        burstSize: 80,
      });
    ...
    it('should respect total particle cap with sparkles', () => {
      ...
      const capPattern = new FireworksPattern(theme, new Mulberry32(42), {
    ...
    it('should spawn zero sparkles when chance is 0', () => {
      const noSparklePattern = new FireworksPattern(theme, new Mulberry32(42), {
        sparkleChance: 0,
      });
    ...
    it('should handle maximum sparkle chance (1.0)', () => {
      const maxSparklePattern = new FireworksPattern(theme, new Mulberry32(42), {
        sparkleChance: 1.0,
      });
    ...
    it('should handle sparkle spawn under maximum particle cap', () => {
      ...
      const capmaxPattern = new FireworksPattern(theme, new Mulberry32(42), {
        sparkleChance: 1.0,
        burstSize: 150,
      });
    ...
    it('should memory-safe: no accumulation with high sparkle rate', () => {
      ...
      const leakTestPattern = new FireworksPattern(theme, new Mulberry32(42), {
        sparkleChance: 1.0,
